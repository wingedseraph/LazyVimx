...
LazyVimx é uma configuração de Neovim potenciada por [💤 lazy.nvim](https://github.com/folke/lazy.nvim)
para tornar fácil customizar e extender a tua configuração.
Em vez de ter de escolher entre começar de raiz ou usar
uma distribuição pré-feita, LazyVimx oferece o melhor
...
Podes encontrar uma template **LazyVimx** starter para começar, [aqui](https://github.com/LazyVimx/starter)
...
<details><summary>Instala a template <a href="https://github.com/LazyVimx/starter">LazyVimx Starter</a></summary>
...
- Inicia o Neovim!
  ...
  Consulta os comentários nos ficheiros sobre como customizar **LazyVimx**.
...
**LazyVimx** vem com um conjunto de ficheiros
que serão carregados **_antes_** dos teus. Lẽ mais [aqui](https://github.com/LazyVimx/LazyVimx/tree/main/lua/lazyvim/config)
